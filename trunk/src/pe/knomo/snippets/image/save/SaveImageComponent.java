...
public class SaveImageComponent extends Component implements ActionListener {

	/**
	 * 
	 */

	String descs[] = { "Original", "Convolve : LowPass", "Convolve : Sharpen", "KnomoTest", "LookupOp", };
	...
	public static final float[] KNOMOTEST3x3 = { // sharpening filter kernel
	0.5f, 0.f, 0.5f,
	0.f, 0.f, 0.f,
	0.5f, 0.f, 0.5f };
	...
	public SaveImageComponent() {
		try {
			bi = ImageIO.read(new File("rsc/lexi_recycle.png"));
			w = bi.getWidth(null);
			h = bi.getHeight(null);
	...
	public void filterImage() {
		...
		case 3: /* knomotest */
			op = new ConvolveOp(new Kernel(3, 3, KNOMOTEST3x3), ConvolveOp.EDGE_NO_OP, null);
			break;
